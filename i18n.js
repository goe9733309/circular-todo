  ...
  var dict = {
    ko: {
      ...
      privacy: {
        ...
        p1: "이 사이트에서 입력하는 일정, 색상, 표시 설정 등은 모두 <b>방문자의 브라우저(localStorage)</b>에만 저장됩니다. 이 사이트를 운영하는 서버로 전송되거나 별도의 데이터베이스에 수집·저장되지 않으며, 브라우저 저장 공간을 비우거나 다른 기기·다른 브라우저로 접속하면 해당 데이터는 함께 이동하지 않습니다.",
        ...
        h2_3: "3. 제3자가 수집하는 정보",
        p3: "이 사이트에 접속하면 호스팅·광고 서비스 제공업체(예: GitHub Pages, Google)가 표준적인 접속 로그(브라우저 종류, 대략적인 지역, 방문 페이지 등)를 자체적으로 수집할 수 있습니다. 이는 이 사이트 운영자가 직접 수집·보관하는 정보가 아니며, 각 서비스 제공업체의 개인정보처리방침을 따릅니다.",
        h2_4: "4. 아동 개인정보",
        ...
        lastUpdated: "최종 업데이트: 2026년 7월 24일"
      },
      app: {
    ...
    en: {
      ...
      privacy: {
        ...
        p1: "Any tasks, colors, and display settings you enter on this site are stored only in <b>your browser (localStorage)</b>. They are never sent to a server or collected in a database, and they do not follow you if you clear your browser storage or switch to a different device or browser.",
        ...
        p3: "Hosting and advertising providers (e.g. GitHub Pages, Google) may independently collect standard access logs (browser type, approximate region, pages visited) when you access this site. This is not information collected or retained by this site's operator, and is governed by each provider's own privacy policy.",
